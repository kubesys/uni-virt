...
docker build base/centos7 -t ${IMAGE_TAG_PREFIX}/kubevirt-centos7-base:latest --platform linux/amd64
docker build virtlet/centos7 -t ${IMAGE_TAG_PREFIX}/kubevirt-centos7-virtlet:${VERSION} --platform linux/amd64
docker build virtctl/centos7 -t ${IMAGE_TAG_PREFIX}/kubevirt-centos7-virtctl:${VERSION} --platform linux/amd64
docker build libvirtwatcher/centos7 -t ${IMAGE_TAG_PREFIX}/kubevirt-centos7-libvirtwatcher:${VERSION} --platform linux/amd64
docker build virtmonitor/centos7 -t ${IMAGE_TAG_PREFIX}/kubevirt-centos7-virtmonitor:${VERSION} --platform linux/amd64

#step 3 docker push

docker push ${IMAGE_TAG_PREFIX}/kubevirt-centos7-base:latest
docker push ${IMAGE_TAG_PREFIX}/kubevirt-centos7-virtctl:${VERSION}
docker push ${IMAGE_TAG_PREFIX}/kubevirt-centos7-virtlet:${VERSION}
docker push ${IMAGE_TAG_PREFIX}/kubevirt-centos7-libvirtwatcher:${VERSION}
docker push ${IMAGE_TAG_PREFIX}/kubevirt-centos7-virtmonitor:${VERSION}
