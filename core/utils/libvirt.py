...
class virDomain(object):
    ...
    def detachDeviceAlias(self, alias, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainDetachDeviceAlias() failed', dom=self)
        return ret
    ...
    def launchSecurityInfo(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virDomainGetLaunchSecurityInfo() failed', dom=self)
        return ret
    ...
    def managedSaveDefineXML(self, dxml, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainManagedSaveDefineXML() failed', dom=self)
        return ret
    ...
    def managedSaveGetXMLDesc(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virDomainManagedSaveGetXMLDesc() failed', dom=self)
        return ret
    ...
    def setBlockThreshold(self, dev, threshold, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainSetBlockThreshold() failed', dom=self)
        return ret
    ...
    def setLifecycleAction(self, type, action, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainSetLifecycleAction() failed', dom=self)
        return ret
    ...
    def setVcpu(self, vcpumap, state, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainSetVcpu() failed', dom=self)
        return ret
...
class virStorageVol(object):
    ...
    def infoFlags(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virStorageVolGetInfoFlags() failed', vol=self)
        return ret
...
class virConnect(object):
    ...
    def baselineHypervisorCPU(self, emulator, arch, machine, virttype, xmlCPUs, flags=0):
        ...
        if ret is None: raise libvirtError ('virConnectBaselineHypervisorCPU() failed', conn=self)
        return ret
    ...
    def compareHypervisorCPU(self, emulator, arch, machine, virttype, xmlCPU, flags=0):
        ...
        if ret == -1: raise libvirtError ('virConnectCompareHypervisorCPU() failed', conn=self)
        return ret
    ...
    def nwfilterBindingCreateXML(self, xml, flags=0):
        ...
        if ret is None:raise libvirtError('virNWFilterBindingCreateXML() failed', conn=self)
    ...
    def nwfilterBindingLookupByPortDev(self, portdev):
        ...
        if ret is None:raise libvirtError('virNWFilterBindingLookupByPortDev() failed', conn=self)
        __tmp = virNWFilterBinding(self, _obj=ret)
        return __tmp
    ...
    def storagePoolLookupByTargetPath(self, path):
        ...
        if ret is None:raise libvirtError('virStoragePoolLookupByTargetPath() failed', conn=self)
        __tmp = virStoragePool(self, _obj=ret)
        return __tmp
...
class virNWFilterBinding(object):
    ...
    def XMLDesc(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virNWFilterBindingGetXMLDesc() failed')
        return ret
    ...
    def delete(self):
        ...
        if ret == -1: raise libvirtError ('virNWFilterBindingDelete() failed')
        return ret
