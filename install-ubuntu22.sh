...
pip3 install --ignore-installed pyinstaller setuptools wheel threadpool prometheus_client kubernetes xmljson xmltodict watchdog pyyaml grpcio grpcio-tools protobuf psutil
