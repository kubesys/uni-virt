...
pip3 install --ignore-installed google threadpool prometheus_client kubernetes==27.2.0 libvirt-python==5.9.0 xmljson xmltodict watchdog pyyaml grpcio grpcio-tools protobuf psutil pyinstaller
